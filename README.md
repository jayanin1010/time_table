  ...
  STEP 3
  Create a simple table using ___tag in html.
  
  STEP 4
  Add header row using ____tag.
  
  STEP 5
  Add your timetable using ___tag.
  ...
  OUTPUT
  ![image](https://github.com/user-attachments/assets/3e03886b-c097-4047-843c-959197e9b61b)
